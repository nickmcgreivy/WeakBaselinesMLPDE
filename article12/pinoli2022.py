...
def replicate_experiment(key, Re, t_runtime, nx_exact, cfl_safety_exact, nxs_dg, cfl_safeties):
...
# replicate first column of table 1

Re = 20
t_runtime = 50.0
cfl_safeties = [2.0]#, 8.0]
cfl_safety_exact = 0.25
replicate_experiment(key, Re, t_runtime, nx_exact, cfl_safety_exact, nxs_dg, cfl_safeties)
